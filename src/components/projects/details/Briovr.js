...
const personas = [
  {name:'Tony', age:'34', img: briop1,
    ...
    statues:['A veteran interaction designer with previous experiences in mobile and web design', 'Knows little about game engines'],
  ...
  {name:'Amy', age: '20', img: briop2,
    description:'Amy is a student that studying art in university. She\'s really interested in the new technology of AR and VR and she\'s taking classes that use Unity as the main tool kit. She has team assignments to create 3D experiences when talking to the team, she wants something to present her thoughts.',
...
const takeaways = [
  ...
  {title:'Work Smart', content:'Sometimes, it\'s cool to break the rules and change the workflow. We tested the feature as we developing it. This wasn\'t the regular workflow, but for this feature, it actually shortens the development circle.'}
]
      ...
      <div className='project-content animated'>
        ...
        <div className='project-section'>
          ...
          <ul>
            ...
            <li>Responsive to the object's movements and size changes in real-time</li>
        ...
        <ul>
          ...
          <li>For game engines like Unreal and Unity, they also use split views to identify the space.</li>
        ...
        <p>I found that 3d modeling software and game engines are for users that are trained to view the 3d space using
          different viewports. While AR apps provide a better solution for regular users that don't have many experiences
          with professional 3d software.
        </p>
        <p>Also as human, we do have a natural understanding of the 3-dimensional world by observing the size of we see an object and its shadow.</p>
        ...
        <div className='project-section'>
          ...
          <div className='split-section'>
            ...
            <div className='split-right'>
              ...
              <p>I used simple elements to test out my assumptions: a cube, the grid, and the indicator. The sketches include
                something similar to real-world shadows that would be affected by the shape of the objects, also something more abstract
                (a ring that represents the rough size of the object).
              </p>
            </div>
          </div>
          ...
          <p>In this phase, I was focusing on the colour and shape of the various indicators. It showed that what colour would be more visible with different background colours.
          </p>
          <p>After building the mockup, I showed it to the team that was working on other features. Before getting into it, I explain what was expected for the indicator. Here's the list I've mentioned to the team:
          </p>
          ...
          <ul>
            ...
            <li>Be visible and self-explanatory</li>
            <li>Be very light in terms of rendering & calculation within the web app</li>
          </ul>
          <p>From the feedback from the team, I learned that using an abstract base that won't be affected by the shape of the object would be a better choice in terms of performance. This helped me filtered out the real-time shadow like indicators and focused more on the abstract ring shapes.
          </p>

          <div className='project-image'><img src={briodesign}/></div>

          <h3 className='section-title'>The Base</h3>
          <p className='first-section-par'>I worked on a variety of the abstract bases and for each round, I asked artists and other team members for their feedback.</p>
          <p>After several iterations, the base became something similar to the final design: a ring shape with a dotted outline.</p>

          <div className='split-section'>
            <div className='split-left'><img src={briodesign2}/></div>
            <div className='split-right'>
              <h3 className='section-title'>The Height Ruler</h3>
              <p className='first-section-par'>It was easier to design the height indicator after setting the base style and colour
                from the base. The height indicator was referring to rulers and grid system we were using in Brio. The distance
                between each dot is the same distance between each 'x' on the grid. In this way, users wouldn't need to think
                about whether the distances were the same.</p>
            </div>
          </div>
          ...
          <ul>
            <li>When - The indicator appears when an object is being manipulated (move, scale, rotate)</li>
            <li>Where - The base should always be on the grid. The other side of the indicator should be in from the center of the object.</li>
          ...
          <p className='list-title'>I included the following aspects in the mockup:</p>
          <ul>
            <li>A variety of shapes of objects (using objects from Google Poly library)</li>
            <li>Different sizes of objects</li>
            <li>Objects that were rotated to different angles</li>
          </ul>

          <p className='list-title'>From the mockup, I added 2 more rules based on the tests and discoveries:</p>
          <ul>
            <li>The bottom part of the indicator has a minimum and a maximum size, so it won't get lost when the model is either too small or too big</li>
          ...
          <div className='split-section'>
            ...
            <div className='split-right'>
              ...
              <p className='first-section-par'>To make the indicator more responsive and obvious, I added some animation to make it
                react more to the user's interactions. For the height indicator, it pops up a sphere when the object
                moves up (or down underneath the grid) 0.5 meters (Brio unit). And a sphere will disappear when it
                reaches the base on both ways. The motion brought the indicator a bit more characteristics but not too much.
              </p>
            </div>
          ...
          <p>The design doc contains the basic designs of the indicator. Since it was different than 2D design, there
            wasn't too many pixels related aspects. The mockup was passed to the developer along with this design doc
            so he could have a better understanding of the feature and see the animation easier.</p>

          <h3 className='section-title'>Test It Out</h3>
          <p className='first-section-par'>It's different to prototype in 3D space and it's different to test within
            3D space. After talking to the developer that was assigned to the task, we decided to use the prototype
            as a reference to start developing and test it out when the indicator is intractable.
          </p>
          <p className='list-title'>The tests were focusing on the following questions that I wasn't sure when doing tests on 2D prototypes:</p>
          <ul>
          ...
          <p className='first-section-par list-title'>Just like the mockup, we used objects with different shape and sizes and tested with different people in-house. From the result, we changed the following things:</p>
          <ul>
            <li>The maximum size of the bottom indicator</li>
            <li>The minimum size of the bottom indicator</li>
          ...
          <p>In addition to the list, we changed the animation to a simpler one due to the development timeline.</p>
        ...
        <div className='project-section'>
          ...
          <p className='list-title'>The final result of the indicator helped to locate objects within a 3D space. From our analytics, I found that it surprisingly helped a lot on the waypoints other than 3D objects. For future developments, I would love to include:
          </p>
          <ul>
            ...
            <li>Add indicator support when the user drags model from the Brio library or Google Poly library and from their computer</li>
          </ul>
